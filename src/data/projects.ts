...
export const projects: Project[] = [
	...
	},
	{
		...
		stack: ['TypeScript', 'React', 'Next.js', 'Node.js', 'PostgreSQL', 'Stripe', 'Terraform', 'GCP/GKE', 'Claude Code'],
		featured: true,
	},
	{
		name: 'Anti-Counterfeiting in the Wine industry',
		dates: 'Jan 2021 – Mar 2025',
		status: 'Various Engagements',
		blurb:
			'Worked with a client in the Anti-Counterfeiting business on their brand protection system used by Wineries (mostly in California). Involved hierarchical QR codes, analytics dashboards and geocoding visualizations.',
		stack: ['PHP', 'Symphony', 'PostgreSQL', 'Azure'],
		featured: true,
	},
	{
		name: 'ScheduleGofer',
